...
def parse_args():
    ...
    #### 모델 선언 ####
    parser.add_argument("--model", default="LGBM", choices=['AdaBoost', 'GradBoost, XGBCBoost, CatBoost', 'LGBM'], type=str, help="model select")
    
    # Boost 모델 공통
    parser.add_argument('--test_size', default=0.2, type=float, help='Train/Valid split 비율을 조정할 수 있습니다.')
    parser.add_argument("--n_estimators", default=30, type=int, help="number of epochs")
    ...
    if parser.parse_args().model == 'AdaBoost':
        ...
        parser.add_argument('--num_boost_round', default=500, type=float, help='')
